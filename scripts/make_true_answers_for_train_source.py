...
PATH_TO_TRAIN_SOURCE = '/home/cardsmobile_data/_EAN_13/train_source'
PROJECT_PATH = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
RESULT_PATH = os.path.join(PROJECT_PATH, 'resource', '_EAN_13', 'results')
...
true_types_train_source.to_excel(writer, 'Sheet1')
writer.save()